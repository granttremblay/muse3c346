...
# you need to install pyspeckit and spectral cube
# i.e., pip install pyspeckit; pip install spectral-cube
...
cube = spectral_cube.SpectralCube.read('DATACUBE_FINAL.fits', hdu=1)
